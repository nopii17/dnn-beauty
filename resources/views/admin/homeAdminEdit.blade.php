...
<img src="{{asset("assets/hero.png")}}" class="my-10" alt="Background Hero"/>
<div class="p-10">
    ...
    <div class="grid grid-cols-3 px-14 items-center gap-x-7 mt-8">
        <div class="bg-[#FDCEDF] col-span-1 flex flex-col">
            <img src="{{asset("assets/collection-face.png")}}" alt=""/>
        ...
        <div class="bg-[#FDCEDF] col-span-1 flex flex-col">
            <img src="{{asset("assets/collection-hair.png")}}" alt=""/>
            <div class="flex flex-col items-center uppercase py-1">
        ...
        <div class="bg-[#FDCEDF] col-span-1 flex flex-col">
            <img src="{{asset("assets/collection-body.png")}}" alt=""/>
            <div class="flex flex-col items-center uppercase py-1">
