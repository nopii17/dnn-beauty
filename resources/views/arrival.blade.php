...
<head>
    ...
    <link
        ...
        rel="stylesheet"/>
    <title>New Arrival | DNN Beauty</title>
</head>
...
<div class="grid grid-cols-7 gap-x-14 px-16 my-14">
    <div class="col-span-2 border border-[#F2BED1] h-min">
        <div class="flex items-center py-7 justify-center uppercase text-2xl border border-[#F2BED1]">
            <p>Home</p>
            <p class="font-semibold ml-1">&gt; New Arrival</p>
        </div>
    ...
    <div class="col-span-5">
        ...
        <div class="flex gap-x-3 mt-3">
            <img src="./assets/arrival-voucher-1.png" class="w-64" alt=""/>
            <img src="./assets/arrival-voucher-2.png" class="w-64" alt=""/>
        </div>
        <div class="flex gap-x-10 mt-20">
            <div class="flex flex-col w-[16rem] gap-y-1">
                <img src="assets/arrival/1.png" alt="Product" class="w-full"/>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                     class="bi bi-heart ml-auto cursor-pointer" viewBox="0 0 16 16">
                    <path
                        d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15"/>
                </svg>
                <p class="uppercase font-medium text-[#E31962]">New</p>
                <p class="font-bold text-xl">THE ORIGINOTE</p>
                <p class="font-light text-sm">CICA Sooting Moisturizer</p>
                <p class="font-medium text-lg">Rp 45.000</p>
                <button class="bg-[#D9D9D9] flex py-1 items-center justify-center font-bold uppercase drop-shadow-md">
                    Add To Cart
                </button>
            </div>
            <div class="flex flex-col w-[16rem] gap-y-1">
                <img src="assets/arrival/2.png" alt="Product" class="w-full"/>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                     class="bi bi-heart ml-auto cursor-pointer" viewBox="0 0 16 16">
                    <path
                        d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15"/>
                ...
                <p class="uppercase font-medium text-[#E31962]">New</p>
                <p class="font-bold text-xl">COSRX</p>
                <p class="font-light text-sm">Aloe Soothing Sun Cream</p>
                <p class="font-medium text-lg">Rp 89.000</p>
                <button class="bg-[#D9D9D9] flex py-1 items-center justify-center font-bold uppercase drop-shadow-md">
                    Add To Cart
                </button>
            </div>
            <div class="flex flex-col w-[16rem] gap-y-1">
                <img src="assets/arrival/3.png" alt="Product" class="w-full"/>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                     class="bi bi-heart ml-auto cursor-pointer" viewBox="0 0 16 16">
                    <path
                        d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15"/>
                ...
                <p class="font-light text-sm">CICA Clear Pad</p>
                <p class="font-medium text-lg">Rp 169.000</p>
                <button class="bg-[#D9D9D9] flex py-1 items-center justify-center font-bold uppercase drop-shadow-md">
                    Add To Cart
                </button>
            </div>
        ...
        <div class="flex gap-x-10 mt-20">
            <div class="flex flex-col w-[16rem] gap-y-1">
                <img src="assets/arrival/4.png" alt="Product" class="w-full"/>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                     class="bi bi-heart ml-auto cursor-pointer" viewBox="0 0 16 16">
                    <path
                        d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15"/>
                ...
                <p class="uppercase font-medium text-[#E31962]">New</p>
                <p class="font-bold text-xl">OLAPLEX</p>
                <p class="font-light text-sm">Bonding Oil</p>
                <p class="font-medium text-lg">Rp 80.000</p>
                <button class="bg-[#D9D9D9] flex py-1 items-center justify-center font-bold uppercase drop-shadow-md">
                    Add To Cart
                </button>
            </div>
            <div class="flex flex-col w-[16rem] gap-y-1">
                <img src="assets/arrival/5.png" alt="Product" class="w-full"/>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                     class="bi bi-heart ml-auto cursor-pointer" viewBox="0 0 16 16">
                    <path
                        d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15"/>
                ...
                <p class="uppercase font-medium text-[#E31962]">New</p>
                <p class="font-bold text-xl">GISOU</p>
                <p class="font-light text-sm">Honey Infused Treatment</p>
                <p class="font-medium text-lg">Rp 68.000</p>
                <button class="bg-[#D9D9D9] flex py-1 items-center justify-center font-bold uppercase drop-shadow-md">
                    Add To Cart
                </button>
            </div>
            <div class="flex flex-col w-[16rem] gap-y-1">
                <img src="assets/arrival/6.png" alt="Product" class="w-full"/>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                     class="bi bi-heart ml-auto cursor-pointer" viewBox="0 0 16 16">
                    <path
                        d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15"/>
                ...
                <p class="uppercase font-medium text-[#E31962]">New</p>
                <p class="font-bold text-xl">GOSOU</p>
                <p class="font-light text-sm">Honey Infused Hair Mask</p>
                <p class="font-medium text-lg">Rp 180.000</p>
                <button class="bg-[#D9D9D9] flex py-1 items-center justify-center font-bold uppercase drop-shadow-md">
                    Add To Cart
                </button>
            </div>
        ...
        <div class="flex gap-x-10 mt-20">
            <div class="flex flex-col w-[16rem] gap-y-1">
                <img src="assets/arrival/7.png" alt="Product" class="w-full"/>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                     class="bi bi-heart ml-auto cursor-pointer" viewBox="0 0 16 16">
                    <path
                        d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15"/>
                ...
                <p class="uppercase font-medium text-[#E31962]">New</p>
                <p class="font-bold text-xl">TREE HUT</p>
                <p class="font-light text-sm">Vanilla Shea Sugar Scrub</p>
                <p class="font-medium text-lg">Rp 32.000</p>
                <button class="bg-[#D9D9D9] flex py-1 items-center justify-center font-bold uppercase drop-shadow-md">
                    Add To Cart
                </button>
            </div>
            <div class="flex flex-col w-[16rem] gap-y-1">
                <img src="assets/arrival/8.png" alt="Product" class="w-full"/>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                     class="bi bi-heart ml-auto cursor-pointer" viewBox="0 0 16 16">
                    <path
                        d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15"/>
                ...
                <p class="font-light text-sm">Scalp & Body Scrub</p>
            ...
            <div class="flex flex-col w-[16rem] gap-y-1">
                <img src="assets/arrival/9.png" alt="Product" class="w-full"/>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                     class="bi bi-heart ml-auto cursor-pointer" viewBox="0 0 16 16">
                    <path
                        d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15"/>
                ...
                <p class="uppercase font-medium text-[#E31962]">New</p>
                <p class="font-bold text-xl">KAI</p>
                <p class="font-light text-sm">Kai Body Wash</p>
                <p class="font-medium text-lg">Rp 97.000</p>
                <button class="bg-[#D9D9D9] flex py-1 items-center justify-center font-bold uppercase drop-shadow-md">
                    Add To Cart
                </button>
            </div>
        ...
        <div class="flex gap-x-10 mt-20">
            <div class="flex flex-col w-[16rem] gap-y-1">
                <img src="assets/arrival/10.png" alt="Product" class="w-full"/>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                     class="bi bi-heart ml-auto cursor-pointer" viewBox="0 0 16 16">
                    <path
                        d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15"/>
                ...
                <p class="font-light text-sm">Almond Milk & Honey Scrub</p>
                <p class="font-medium text-lg">Rp 149.000</p>
                <button class="bg-[#D9D9D9] flex py-1 items-center justify-center font-bold uppercase drop-shadow-md">
                    Add To Cart
                </button>
            </div>
            <div class="flex flex-col w-[16rem] gap-y-1">
                <img src="assets/arrival/11.png" alt="Product" class="w-full"/>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                     class="bi bi-heart ml-auto cursor-pointer" viewBox="0 0 16 16">
                    <path
                        d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15"/>
                ...
                <p class="uppercase font-medium text-[#E31962]">New</p>
                <p class="font-bold text-xl">BUBBLE</p>
                <p class="font-light text-sm">Slam Dunk Moisturizer</p>
                <p class="font-medium text-lg">Rp 72.000</p>
                <button class="bg-[#D9D9D9] flex py-1 items-center justify-center font-bold uppercase drop-shadow-md">
                    Add To Cart
                </button>
            </div>
            <div class="flex flex-col w-[16rem] gap-y-1">
                <img src="assets/arrival/12.png" alt="Product" class="w-full"/>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                     class="bi bi-heart ml-auto cursor-pointer" viewBox="0 0 16 16">
                    <path
                        d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15"/>
                ...
                <p class="uppercase font-medium text-[#E31962]">New</p>
                <p class="font-bold text-xl">GLOW RECIPE</p>
                <p class="font-light text-sm">Avocado Melt Retinol Mask</p>
                <p class="font-medium text-lg">Rp 168.000</p>
                <button class="bg-[#D9D9D9] flex py-1 items-center justify-center font-bold uppercase drop-shadow-md">
                    Add To Cart
                </button>
            </div>
        ...
        <div class="flex gap-x-10 mt-20">
            <div class="flex flex-col w-[16rem] gap-y-1">
                <img src="assets/arrival/13.png" alt="Product" class="w-full"/>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                     class="bi bi-heart ml-auto cursor-pointer" viewBox="0 0 16 16">
                    <path
                        d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15"/>
                ...
                <p class="uppercase font-medium text-[#E31962]">New</p>
                <p class="font-bold text-xl">CERAVE</p>
                <p class="font-light text-sm">Foaming Facial Cleanser</p>
                <p class="font-medium text-lg">Rp 320.000</p>
                <button class="bg-[#D9D9D9] flex py-1 items-center justify-center font-bold uppercase drop-shadow-md">
                    Add To Cart
                </button>
            </div>
            <div class="flex flex-col w-[16rem] gap-y-1">
                <img src="assets/arrival/14.png" alt="Product" class="w-full"/>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                     class="bi bi-heart ml-auto cursor-pointer" viewBox="0 0 16 16">
                    <path
                        d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15"/>
                ...
                <p class="uppercase font-medium text-[#E31962]">New</p>
                <p class="font-bold text-xl">SKINFOOD</p>
                <p class="font-light text-sm">Rice Soft Scrub</p>
                <p class="font-medium text-lg">Rp 47.000</p>
                <button class="bg-[#D9D9D9] flex py-1 items-center justify-center font-bold uppercase drop-shadow-md">
                    Add To Cart
                </button>
            </div>
            <div class="flex flex-col w-[16rem] gap-y-1">
                <img src="assets/arrival/15.png" alt="Product" class="w-full"/>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                     class="bi bi-heart ml-auto cursor-pointer" viewBox="0 0 16 16">
                    <path
                        d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15"/>
                ...
                <p class="font-medium text-lg">Rp 100.000</p>
                <button class="bg-[#D9D9D9] flex py-1 items-center justify-center font-bold uppercase drop-shadow-md">
                    Add To Cart
                </button>
            </div>
        ...
        <div class="flex gap-x-10 mt-20">
            <div class="flex flex-col w-[16rem] gap-y-1">
                <img src="assets/arrival/16.png" alt="Product" class="w-full"/>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                     class="bi bi-heart ml-auto cursor-pointer" viewBox="0 0 16 16">
                    <path
                        d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15"/>
                ...
                <p class="uppercase font-medium text-[#E31962]">New</p>
                <p class="font-bold text-xl">THE ORDINARY</p>
                <p class="font-light text-sm">Glycolic Acid 7% Solution</p>
                <p class="font-medium text-lg">Rp 387.000</p>
                <button class="bg-[#D9D9D9] flex py-1 items-center justify-center font-bold uppercase drop-shadow-md">
                    Add To Cart
                </button>
            </div>
            <div class="flex flex-col w-[16rem] gap-y-1">
                <img src="assets/arrival/17.png" alt="Product" class="w-full"/>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                     class="bi bi-heart ml-auto cursor-pointer" viewBox="0 0 16 16">
                    <path
                        d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15"/>
                ...
                <p class="uppercase font-medium text-[#E31962]">New</p>
                <p class="font-bold text-xl">MARIO BADESCU</p>
                <p class="font-light text-sm">Drying Lotion</p>
                <p class="font-medium text-lg">Rp 39.000</p>
                <button class="bg-[#D9D9D9] flex py-1 items-center justify-center font-bold uppercase drop-shadow-md">
                    Add To Cart
                </button>
            </div>
            <div class="flex flex-col w-[16rem] gap-y-1">
                <img src="assets/arrival/18.png" alt="Product" class="w-full"/>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                     class="bi bi-heart ml-auto cursor-pointer" viewBox="0 0 16 16">
                    <path
                        d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15"/>
                ...
                <p class="font-medium text-lg">Rp 230.000</p>
                <button class="bg-[#D9D9D9] flex py-1 items-center justify-center font-bold uppercase drop-shadow-md">
                    Add To Cart
                </button>
            </div>
