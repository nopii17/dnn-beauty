...
<table class="w-full mx-auto min-w-max table-auto my-8 border-collapse">
    ...
    <tr class="border-b border-gray-200">
        <td class="text-left">
            <div class="flex gap-x-5 items-center px-8">
                <img src="./assets/collections/OUAI Detox Shampoo 300ml.jpg" alt="Product 1" class="h-24"/>
    ...
    <tr class="border-b border-gray-200">
        <td class="text-left">
            <div class="flex gap-x-5 items-center px-8">
                <img src="./assets/collections/Gisou Honey Infused Scalp Treatment, Size_ 100ml.jpg" alt="Product 1"
                     class="h-24"/>
                <div class="flex flex-col justify-center">
    ...
    <tr class="border-b border-gray-200">
        <td class="text-left">
            <div class="flex gap-x-5 items-center px-8">
                <img src="./assets/collections/skintific.jpg" alt="Product 1" class="h-24"/>
                <div class="flex flex-col justify-center">
    ...
    <tr class="border-b border-gray-200">
        <td class="text-left">
            <div class="flex gap-x-5 items-center px-8">
                <img src="./assets/best-seller/7.png" alt="Product 1" class="h-24"/>
                <div class="flex flex-col justify-center">
    ...
    <tr class="border-b border-gray-200">
        <td class="text-left">
            <div class="flex gap-x-5 items-center px-8">
                <img src="./assets/best-seller/11.png" alt="Product 1" class="h-24"/>
                <div class="flex flex-col justify-center">
