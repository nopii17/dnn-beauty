...
<head>
    ...
    <link
        ...
        rel="stylesheet"/>
    <title>Our Products | DNN Beauty</title>
</head>
...
<div class="grid grid-cols-7 gap-x-14 px-16 my-14">
    <div class="col-span-2 border border-[#F2BED1] h-fit">
        <div class="flex items-center py-7 justify-center uppercase text-2xl border border-[#F2BED1]">
            <p>Home</p>
            <p class="font-semibold ml-1">&gt; Our Product</p>
        </div>
        <div class="flex px-8 flex-col py-5 row-span-2 uppercase text-2xl border border-[#F2BED1]">
            ...
            <div class="flex flex-col gap-y-5 my-5 text-sm capitalize w-fit">
                ...
                <p class="border border-[#F2BED1] px-5 py-3">New Arrival</p>
            </div>
        </div>
        <div class="flex px-8 flex-col py-5 row-span-2 uppercase text-2xl border border-[#F2BED1]">
            <button class="bg-[#F2BED1] uppercase px-5 w-min py-2 flex items-center gap-x-2">
    ...
    <div class="col-span-5">
        ...
        <div class="flex gap-x-3 mt-3">
            <img src="./assets/product-voucher-1.png" class="w-64" alt=""/>
            <img src="./assets/product-voucher-2.png" class="w-64" alt=""/>
        </div>
        <div class="flex gap-x-10 mt-20">
            <div class="flex flex-col w-[16rem] gap-y-1">
                <img src="assets/product/1.png" alt="Product" class="w-full"/>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                     class="bi bi-heart ml-auto cursor-pointer" viewBox="0 0 16 16">
                    <path
                        d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15"/>
                </svg>
                <p class="font-light text-sm">Bora Barrie Repair Cream</p>
                <p class="font-bold text-xl">DNN BEAUTY</p>
            ...
            <div class="flex flex-col w-[16rem] gap-y-1">
                <img src="assets/product/2.png" alt="Product" class="w-full"/>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                     class="bi bi-heart ml-auto cursor-pointer" viewBox="0 0 16 16">
                    <path
                        d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15"/>
                </svg>
                <p class="font-light text-sm">Lala Retro Whipped Cream</p>
                <p class="font-bold text-xl">DNN BEAUTY</p>
                <p class="font-medium text-lg border border-[#F2BED1] text-center">
                    Rp 50.000
                </p>
            ...
            <div class="flex flex-col w-[16rem] gap-y-1">
                <img src="assets/product/3.png" alt="Product" class="w-full"/>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                     class="bi bi-heart ml-auto cursor-pointer" viewBox="0 0 16 16">
                    <path
                        d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15"/>
                </svg>
                <p class="font-light text-sm">Polypeptide Cream</p>
                <p class="font-bold text-xl">DNN BEAUTY</p>
                <p class="font-medium text-lg border border-[#F2BED1] text-center">
                    Rp 75.000
                </p>
        ...
        <div class="flex gap-x-10 mt-20">
            <div class="flex flex-col w-[16rem] gap-y-1">
                <img src="assets/product/4.png" alt="Product" class="w-full"/>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                     class="bi bi-heart ml-auto cursor-pointer" viewBox="0 0 16 16">
                    <path
                        d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15"/>
                </svg>
                <p class="font-light text-sm">Sukari Hair Serum</p>
                <p class="font-bold text-xl">DNN BEAUTY</p>
                <p class="font-medium text-lg border border-[#F2BED1] text-center">
                    Rp 70.000
                </p>
            ...
            <div class="flex flex-col w-[16rem] gap-y-1">
                <img src="assets/product/5.png" alt="Product" class="w-full"/>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                     class="bi bi-heart ml-auto cursor-pointer" viewBox="0 0 16 16">
                    <path
                        d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15"/>
                </svg>
                <p class="font-light text-sm">Sweet Biome Hair Spray</p>
                <p class="font-bold text-xl">DNN BEAUTY</p>
                <p class="font-medium text-lg border border-[#F2BED1] text-center">
                    Rp 97.000
                </p>
            ...
            <div class="flex flex-col w-[16rem] gap-y-1">
                <img src="assets/product/6.png" alt="Product" class="w-full"/>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                     class="bi bi-heart ml-auto cursor-pointer" viewBox="0 0 16 16">
                    <path
                        d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15"/>
        ...
        <div class="flex gap-x-10 mt-20">
            <div class="flex flex-col w-[16rem] gap-y-1">
                <img src="assets/product/7.png" alt="Product" class="w-full"/>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                     class="bi bi-heart ml-auto cursor-pointer" viewBox="0 0 16 16">
                    <path
                        d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15"/>
                </svg>
                <p class="font-light text-sm">Lala Retro Cream</p>
                <p class="font-bold text-xl">DNN BEAUTY</p>
                <p class="font-medium text-lg border border-[#F2BED1] text-center">
                    Rp 89.000
                </p>
            ...
            <div class="flex flex-col w-[16rem] gap-y-1">
                <img src="assets/product/8.png" alt="Product" class="w-full"/>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                     class="bi bi-heart ml-auto cursor-pointer" viewBox="0 0 16 16">
                    <path
                        d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15"/>
                </svg>
                <p class="font-light text-sm">Sili Body Lotion</p>
                <p class="font-bold text-xl">DNN BEAUTY</p>
                <p class="font-medium text-lg border border-[#F2BED1] text-center">
                    Rp 67.000
                </p>
            ...
            <div class="flex flex-col w-[16rem] gap-y-1">
                <img src="assets/product/9.png" alt="Product" class="w-full"/>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                     class="bi bi-heart ml-auto cursor-pointer" viewBox="0 0 16 16">
                    <path
                        d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15"/>
                </svg>
                <p class="font-light text-sm">Wild Marula Body Spray</p>
                <p class="font-bold text-xl">DNN BEAUTY</p>
                <p class="font-medium text-lg border border-[#F2BED1] text-center">
                    Rp 49.000
                </p>
        ...
        <div class="flex gap-x-10 mt-20">
            <div class="flex flex-col w-[16rem] gap-y-1">
                <img src="assets/product/10.png" alt="Product" class="w-full"/>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                     class="bi bi-heart ml-auto cursor-pointer" viewBox="0 0 16 16">
                    <path
                        d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15"/>
                </svg>
                <p class="font-light text-sm">Glossing Shampoo</p>
                <p class="font-bold text-xl">DNN BEAUTY</p>
                <p class="font-medium text-lg border border-[#F2BED1] text-center">
                    Rp 80.000
                </p>
            ...
            <div class="flex flex-col w-[16rem] gap-y-1">
                <img src="assets/product/11.png" alt="Product" class="w-full"/>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                     class="bi bi-heart ml-auto cursor-pointer" viewBox="0 0 16 16">
                    <path
                        d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15"/>
                </svg>
                <p class="font-light text-sm">Milki Micellar Water</p>
                <p class="font-bold text-xl">DNN BEAUTY</p>
                <p class="font-medium text-lg border border-[#F2BED1] text-center">
                    Rp 30.000
                </p>
            ...
            <div class="flex flex-col w-[16rem] gap-y-1">
                <img src="assets/product/12.png" alt="Product" class="w-full"/>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                     class="bi bi-heart ml-auto cursor-pointer" viewBox="0 0 16 16">
                    <path
                        d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15"/>
                </svg>
                <p class="font-light text-sm">Shaba Complex Serum</p>
                <p class="font-bold text-xl">DNN BEAUTY</p>
                <p class="font-medium text-lg border border-[#F2BED1] text-center">
                    Rp 140.000
                </p>
        ...
        <div class="flex gap-x-10 mt-20">
            <div class="flex flex-col w-[16rem] gap-y-1">
                <img src="assets/product/13.png" alt="Product" class="w-full"/>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                     class="bi bi-heart ml-auto cursor-pointer" viewBox="0 0 16 16">
                    <path
                        d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15"/>
                </svg>
                <p class="font-light text-sm">Maretinol Oil</p>
                <p class="font-bold text-xl">DNN BEAUTY</p>
                <p class="font-medium text-lg border border-[#F2BED1] text-center">
                    Rp 75.000
                </p>
            ...
            <div class="flex flex-col w-[16rem] gap-y-1">
                <img src="assets/product/14.png" alt="Product" class="w-full"/>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                     class="bi bi-heart ml-auto cursor-pointer" viewBox="0 0 16 16">
                    <path
                        d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15"/>
                </svg>
                <p class="font-light text-sm">Electrolyte Waterfacial</p>
                <p class="font-bold text-xl">DNN BEAUTY</p>
                <p class="font-medium text-lg border border-[#F2BED1] text-center">
                    Rp 55.000
                </p>
            ...
            <div class="flex flex-col w-[16rem] gap-y-1">
                <img src="assets/product/15.png" alt="Product" class="w-full"/>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                     class="bi bi-heart ml-auto cursor-pointer" viewBox="0 0 16 16">
                    <path
                        d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15"/>
                </svg>
                <p class="font-light text-sm">Melting Butter Cleanser</p>
                <p class="font-bold text-xl">DNN BEAUTY</p>
                <p class="font-medium text-lg border border-[#F2BED1] text-center">
                    Rp 100.000
                </p>
        ...
        <div class="flex gap-x-10 mt-20">
            <div class="flex flex-col w-[16rem] gap-y-1">
                <img src="assets/product/16.png" alt="Product" class="w-full"/>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                     class="bi bi-heart ml-auto cursor-pointer" viewBox="0 0 16 16">
                    <path
                        d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15"/>
                </svg>
                <p class="font-light text-sm">Deodorant Cream</p>
                <p class="font-bold text-xl">DNN BEAUTY</p>
                <p class="font-medium text-lg border border-[#F2BED1] text-center">
                    Rp 90.000
                </p>
            ...
            <div class="flex flex-col w-[16rem] gap-y-1">
                <img src="assets/product/17.png" alt="Product" class="w-full"/>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                     class="bi bi-heart ml-auto cursor-pointer" viewBox="0 0 16 16">
                    <path
                        d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15"/>
                </svg>
                <p class="font-light text-sm">Jelly Cleanser</p>
                <p class="font-bold text-xl">DNN BEAUTY</p>
                <p class="font-medium text-lg border border-[#F2BED1] text-center">
                    Rp 88.000
                </p>
            ...
            <div class="flex flex-col w-[16rem] gap-y-1">
                <img src="assets/product/18.png" alt="Product" class="w-full"/>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                     class="bi bi-heart ml-auto cursor-pointer" viewBox="0 0 16 16">
                    <path
                        d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15"/>
                </svg>
                <p class="font-light text-sm">Miracle Butter</p>
                <p class="font-bold text-xl">DNN BEAUTY</p>
                <p class="font-medium text-lg border border-[#F2BED1] text-center">
                    Rp 76.000
                </p>
